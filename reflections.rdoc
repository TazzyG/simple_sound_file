...
part 4 - Let's put some code into our list of words in index that looks uses the audo code and uses word.english
          ...
          Had some challenges - google gave me this 
          https://apidock.com/rails/ActionView/Helpers/AssetTagHelper/audio_path
          I will follow this example, audio_path("horse.wav") 
            rename my folder to audios and make the code the same. 
