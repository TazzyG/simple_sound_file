...
Step 8 - Let's save this to git. Reference "RailsTutorial.org" I picked Chapter 2 (any part with the Git steps)
        ...
        I will set up a github repository (instead of bitbucket). What do you know there is one there already. 
        Let's use that. But I see it has a readme... so I will rename this document so we have 2 docs. 
